    ...
    public partial class Productos : Form
    {
        ...
        private void mostrar_grupos()
        {
            ...
            try
            {
                ...
                da = new SqlDataAdapter("mostrarGrupos", con);
        ...
        private void btnGuardar_grupo_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd = new SqlCommand("insertarGrupo", con);
        ...
        private void buscar()
        {
            try
            {
                ...
                da = new SqlDataAdapter("buscarProductosDescripcion", con);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        internal void sumarCostoInventarioContarProductos()
        {
            ...
            try
            {
                ...
                con.Close();
                Console.WriteLine("resultado + + 0 : ", resultado + " " + importe);
            ...
            try
            {
                ...
                con.Close();
                Console.WriteLine("lblcantidad_productos ", conteoresultado);
            ...
            catch (Exception ex)
            {
                ...
                conteoresultado = "";
                Console.WriteLine("conteoresultado 2 ", conteoresultado);
                        ...
                        foreach (DataGridViewRow row in datalistadoGrupos.SelectedRows)
                        {
                            ...
                            try
                            {
                                ...
                                try
                                {
                                    ...
                                    con.ConnectionString = Conexion.ConexionMaestra.conexion;
                                    con.Open();
                                    cmd = new SqlCommand("eliminarGrupos", con);
                                    cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void mostrarDescripcionProductoSinRepetir()
        {
            try
            {
                DataTable dt = new DataTable();
                ...
                da = new SqlDataAdapter("mostrarDescripcionProductoSinRepetir", con);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
